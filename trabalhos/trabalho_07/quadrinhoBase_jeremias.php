        ...
        <main>
            ...
            <div class="row">
                <div class="col img">
                    <table role="tablist">
                        <tr>
                            <th role="columnheader"colspan="2">Jeremias - Pele</th>
                        </tr>
                        
                        <tr>
                            <td role="columnheader">Autor:</td>
                            <td role="cell">Jefferson Costa</td>
                        </tr>
                        <tr>
                            <td role="columnheader">publicado em:</td>
                            <td role="cell">2018</td>
                        </tr>
                        <tr>
                            <td role="columnheader"colspan="2">Editora Graphic MSP</td>
                        </tr>
                    </table>
                </div>
            </div>
